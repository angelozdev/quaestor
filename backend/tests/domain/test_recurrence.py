...
def test_daily_lands_on_consecutive_days():
    got = due_dates(
        date(2026, 1, 1), None, IntervalUnit.day, 1,
        since=date(2026, 1, 1), until=date(2026, 1, 4),
    )
...
def test_every_three_days_counts_forward_from_the_start():
    got = due_dates(
        date(2026, 1, 1), None, IntervalUnit.day, 3,
        since=date(2026, 1, 1), until=date(2026, 1, 10),
    )
...
def test_daily_crosses_a_month_boundary():
    got = due_dates(
        date(2026, 1, 30), None, IntervalUnit.day, 1,
        since=date(2026, 1, 30), until=date(2026, 2, 2),
    )
...
def test_weekly_lands_seven_days_forward_not_back():
    got = due_dates(
        date(2026, 1, 8), None, IntervalUnit.week, 1,
        since=date(2026, 1, 1), until=date(2026, 1, 22),
    )
...
def test_is_due_on_rejects_a_date_past_the_end():
    assert not is_due_on(
        date(2026, 1, 5), date(2026, 1, 12), IntervalUnit.week, 1, date(2026, 1, 19)
    )


def test_is_due_on_accepts_the_end_date_itself():
    assert is_due_on(
        date(2026, 1, 5), date(2026, 1, 12), IntervalUnit.week, 1, date(2026, 1, 12)
    )
