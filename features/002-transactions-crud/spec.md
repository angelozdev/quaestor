...
Scenario: Registering an expense moves the balance down
  ...
  When the user registers an expense of 50000.00 COP from "Bancolombia" paying "Exito"
...
Scenario: Registering an income moves the balance up
  Given an account "Bancolombia" in COP with balance 1000000.00 COP
  When the user registers an income of 2000000.00 COP into "Bancolombia" from "Salario"
...
Scenario: Editing descriptive fields never moves the balance
  Given an account "Bancolombia" in COP with balance 1000000.00 COP
  And a category "Comida"
  And the user registers an expense of 50000.00 COP from "Bancolombia" paying "Exito"
...
Scenario: The category can be cleared
  Given an account "Bancolombia" in COP with balance 100000.00 COP
  And a category "Comida"
  And the user registers an expense of 20000.00 COP from "Bancolombia" paying "Exito" in category "Comida"
  When the user clears the expense's category
  Then viewing the expense shows no category
```
...
Scenario: Tagging at creation
  Given an account "Bancolombia" in COP with balance 100000.00 COP
  When the user registers an expense of 20000.00 COP from "Bancolombia" paying "Exito" tagged "viaje" and "comida"
...
Scenario: The list orders by the transaction's own date, newest first
  Given an account "Bancolombia" in COP with balance 1000000.00 COP
  And the user registers an expense of 10000.00 COP from "Bancolombia" paying "A" dated 2026-07-20
  And the user registers an expense of 10000.00 COP from "Bancolombia" paying "B" dated 2026-07-12
...
Scenario: Planned obligations appear at their due-date position
  Given an account "Bancolombia" in COP with balance 1000000.00 COP
  And the user registers an expense of 10000.00 COP from "Bancolombia" paying "Exito" dated 2026-07-10
...
Scenario: One-cent registrations are accepted
  ...
  When the user registers an expense of 0.01 COP from "Bancolombia" paying "Minimo"
...
Scenario: The date-range filter includes its boundary days
  Given an account "Bancolombia" in COP with balance 1000000.00 COP
  And the user registers an expense of 10000.00 COP from "Bancolombia" paying "Primero" dated 2026-07-01
  And the user registers an expense of 10000.00 COP from "Bancolombia" paying "Ultimo" dated 2026-07-15
  And the user registers an expense of 10000.00 COP from "Bancolombia" paying "Fuera" dated 2026-07-16
...
Scenario Outline: An invalid registration is rejected and nothing changes
  Given an account "Bancolombia" in COP with balance 100000.00 COP
  When the user registers an expense of <amount> <currency> from "Bancolombia"
...
Scenario: Registering into an archived account is rejected
  ...
  When the user registers an expense of 10000.00 COP from "Vieja"
  Then the registration is rejected
...
Scenario: The assistant records a tagged expense like the app
  ...
  When the assistant records an expense of 20000.00 COP from "Bancolombia" paying "Exito" tagged "viaje"
