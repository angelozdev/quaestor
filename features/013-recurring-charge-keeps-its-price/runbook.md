...
- [ ] **agent** — leer las dos reglas y anotar monto, moneda, cuenta y modo
...
- [ ] **agent** — restaurar el respaldo del paso 1 en una base aparte y correr
      la migración ahí
...
- [ ] **agent** — sobre la copia: contar reglas, contar movimientos, y leer el
...
- [ ] **human** — presente mientras corre
- [ ] **agent** — aplicar la migración
- `evidence:` la salida de Alembic con la revisión aplicada

### 6. El dueño lo mira en la app

- [ ] **human** — abrir Recurrentes y ver las dos reglas
...
- [ ] **agent** — dejar escrito el `downgrade` y probarlo sobre la copia del
      paso 3
